    ...
    <div className={`confirm__wrapper ${isOpen ? "open" : "close"}`}>
      <div className="confirm__body">
        ...
        <div className="confirm__btn-container">
          <Button onClick={() => onConfirm(true)}  className="confirm__btn" variant="primary" size="sm">
            Yes
          </Button>
          <Button onClick={() => onConfirm(false)} className="confirm__btn" variant="primary" size="sm">
            No
          </Button>
        </div>
      </div>
